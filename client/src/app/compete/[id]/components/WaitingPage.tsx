...
const WaitingPage = () => {
    ...
    const {chat, sendMessage} = useCompete()
        ...
        <Page>
            ...
            <Start>
                ...
                <Chat>
                    ...
                    <input type="text" value={msg} onChange={(e)=>{setmessage(e.target.value)}} placeholder='write message here...' />
                    <button onClick={()=> (msg.trim()).length > 0 &&  sendMessage(msg)}>send</button>
                </Chat>
        </Page>
    )
}
